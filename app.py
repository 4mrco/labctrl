...
from ui.dialogs import mostrar_sobre, pedir_input, popup_sem_matricula
# ─────────────────────────────────────────────
# DIALOG UTILITIES
# ─────────────────────────────────────────────
...
class App:
    ...
    def _abrir_bolsistas(self):
        ...
        def adicionar():
            nome = pedir_input(self.root, "Adicionar", "Nome:")
            if nome:
    ...
    def _abrir_alunos(self):
        ...
        def editar():
            ...
            novo_nome = pedir_input(self.root, f"Editar — {matricula}", "Novo nome:")
            if novo_nome:
